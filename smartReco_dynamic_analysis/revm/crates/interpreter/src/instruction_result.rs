...
pub enum InstructionResult {
    ...
    // smartReco specific error codes
    ImplicitBugHit,
    CrossContractControlLeak,
}
...
impl From<InstructionResult> for SuccessOrHalt {
    fn from(result: InstructionResult) -> Self {
        match result {
            ...
            InstructionResult::ImplicitBugHit => Self::FatalExternalError,
            InstructionResult::CrossContractControlLeak => Self::FatalExternalError,
        }
    }
}
